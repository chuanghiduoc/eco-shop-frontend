...
const breadcrumbs = [{ id: 1, name: 'Home', href: '#', text: "Danh mục" },
  // { id: 2, name: 'Men123', href: '#' }
]
const filters = [
  {
    id: 'color',
...
export default function CategoryPage() {
  ...
  // Fetch products from Redux store with proper typing
    ...
    <div className="bg-white">
      ...
      <div>
              ...
              {breadcrumbs.map((breadcrumb) => (
                <li key={breadcrumb.id}>
                  <div className="flex items-center">
                    ...
                    <a href="#" aria-current="page" className="ml-4 text-sm text-gray-500 hover:text-gray-600">
                    {breadcrumb.text}
                </a>
                  </div>
                </li>
        ...
        <main className="mx-auto max-w-2xl px-4 lg:max-w-7xl lg:px-8">
          <div className="border-b border-gray-200 pt-8 pb-4">
                  ...
                  >
                    ...
                    <div className="flex flex-1 flex-col space-y-2 p-4">
                      ...
                      <div className="flex flex-1 flex-col justify-end">
                        ...
                        <p className="text-base font-medium text-gray-900">{product.originalPrice}</p>
                      </div>
                    </div>
                  </div>
                ))}
