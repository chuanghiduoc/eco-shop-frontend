...
const CartPage = () =>{
  ...
  return (
    <div className="bg-white">
      <main className="mx-auto max-w-2xl px-4 pb-16 pt-6 sm:px-6 lg:max-w-7xl lg:px-8">
        ...
        <form className="mt-8 lg:grid lg:grid-cols-12 lg:items-start lg:gap-x-12 xl:gap-x-16">
          ...
          <section
            ...
            className="mt-16 rounded-lg bg-gray-50 px-4 py-6 sm:p-6 lg:col-span-5 lg:mt-0 lg:p-8 sticky top-24 z-11"
          >
            <h2
              id="summary-heading"
