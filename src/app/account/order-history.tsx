...
export default function OrderHistory() {
  return (
    <div className="bg-white">
      <div className="mx-auto max-w-7xl lg:pb-24">
        <div className="max-w-xl">
          <h1 className="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Lịch sử đặt hàng</h1>
          <p className="mt-2 text-sm text-gray-500">
          Kiểm tra trạng thái của các đơn đặt hàng gần đây, quản lý trả lại và tải hóa đơn xuống.
          </p>
        </div>

        <div className="mt-16">
          <h2 className="sr-only">Đơn đặt hàng gần đây</h2>
                ...
                <div className="rounded-lg bg-gray-50 px-4 py-6 sm:flex sm:items-center sm:justify-between sm:space-x-6 sm:px-6 lg:space-x-8">
                  <dl className="flex-auto space-y-6 divide-y divide-gray-200 text-sm text-gray-600 sm:grid sm:grid-cols-3 sm:gap-x-6 sm:space-y-0 sm:divide-y-0 lg:w-1/2 lg:flex-none lg:gap-x-8">
                    ...
                    <div className="flex justify-between pt-6 sm:block sm:pt-0">
                      <dt className="font-medium text-gray-900">Số đơn hàng</dt>
                  ...
                  >
                    ...
                    cho đơn hàng  {order.number}</span>
                  </a>
                </div>

                <table className="mt-4 w-full text-gray-500 sm:mt-6">
                  <caption className="sr-only">Các sản phẩm</caption>
                      ...
                      <tr key={product.id}>
                        ...
                        <td className="whitespace-nowrap py-6 text-right font-medium">
                          <a href={product.href} className="text-indigo-600">
                            Xem<span className="hidden lg:inline"> sản phẩm</span>
