...
export default function ShoppingCart({ setCartOpen, cartOpen }: ShoppingCartProps) {
  return (
    <Dialog open={cartOpen} onClose={() => setCartOpen(false)} className="fixed inset-0 overflow-hidden z-50">
